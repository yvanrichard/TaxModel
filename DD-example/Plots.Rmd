...
sds <- list()
sds[[1]] <- DD_rfx$BUGSoutput$sims.list[grepl('pred',names(DD_rfx$BUGSoutput$sims.list))]
sds[[2]] <- DD_rfx_h$BUGSoutput$sims.list[grepl('pred',names(DD_rfx_h$BUGSoutput$sims.list))]
#sds[[3]] <- JM$BUGSoutput$sims.list[grepl('sd',names(JM$BUGSoutput$sims.list))]
